...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (args.containsOption("load") && args.getOptionValues("load").get(0).equals("Yes")) {
            // loading users
            ...
            if (!userService.userExists(emailCarlos) || !userService.userExists(emailSofia)
                    || !userService.userExists(emailPedro) || !userService.userExists(emailMiguel)
                    || !userService.userExists(emailAna)) {
                ...
                userService.register(
                        new User("Ana", emailAna, "ana", "789123456", locationService.getLocation("Porto", "Maia")));
            }
            ...
            Item i1 = new Item("2019 Great Britain Silver Britannia 1 oz .999 BU £2 Brilliant Uncirculated", 1,
                    BigDecimal.valueOf(41.0), "Moeda rara", Categories.MISC);
            i1.setOwner(carlos);
            ...
            Item i2 = new Item("The Cocktail Party [assinado]", 1, BigDecimal.valueOf(200.0), "Livro antigo, assinado",
                    Categories.BOOKS);
            i2.setOwner(carlos);
            ...
            Item i3 = new Item("Vintage Vinyl, Black Sabbath Volume 4. Vertigo Records 1972", 1,
                    BigDecimal.valueOf(23.0), "Disco vinyl antigo", Categories.MUSIC);
            i3.setOwner(sofia);
            ...
            Item i4 = new Item(
                    "Japanese Art Print Dusk by Koho Shoda Vintage Poster, Painting Print, Japanese, Ukiyo e #1098", 1,
                    BigDecimal.valueOf(20.0), "Quadro raro", Categories.ART);
            i4.setSeller(sofia);
            i4.addImage(
                    new URL("https://i.etsystatic.com/16900491/r/il/c479db/1938837110/il_1140xN.1938837110_au3l.jpg"));
            ...
            Item i5 = new Item("1922-1935 Peace Silver Dollar BU", 1, BigDecimal.valueOf(27.0), "Moeda rara",
                    Categories.MISC);
            i5.setOwner(pedro);
            i5.addImage(new URL(
                    "https://www.images-apmex.com/images/Catalog%20Images/Products/170_Obv.jpg?v=20191107093552&width=900&height=900"));
            ...
            Item i6 = new Item("Complete Exodia the Forbidden One Set - All 5 Cards :: 1st Edition LDK2 Mint YuG", 2,
                    BigDecimal.valueOf(17.0), "Cartas raras", Categories.GAMES);
            i6.setOwner(pedro);
            ...
            Item i7 = new Item("1907 $10 Indian Gold MS-62 Quality", 1, BigDecimal.valueOf(1600.0), "Moeda muito rara",
                    Categories.MISC);
            i7.setOwner(carlos);
            i7.addImage(new URL(
                    "https://www.rarecoins.com/media/catalog/product/cache/6/image/500x/040ec09b1e35df139433887a97daa66f/1/9/1907-10-indian-ms-62-holder.png"));
            ...
            Item i9 = new Item("BATMAN FOREVER: THE ARCADE GAME  (PlayStation)", 1, BigDecimal.valueOf(135.0),
                    "Rare game", Categories.GAMES);
            i9.setOwner(pedro);
            ...
            Item i10 = new Item(
                    "CMC 1/18 Ferrari F2 500 Super rare / very Limited 1/18 CMC / Diecast cars 1/18 / CMC products", 1,
                    BigDecimal.valueOf(430.0), "Rare toy", Categories.TOYS);
            i10.setOwner(miguel);
            i10.addImage(
                    new URL("https://i.etsystatic.com/17352431/r/il/82a857/2379398821/il_794xN.2379398821_ey5n.jpg"));
            ...
            Item i12 = new Item("Eric Clapton - I Still Do", 1, BigDecimal.valueOf(135.0), "Rare disc",
                    Categories.MUSIC);
            i12.setOwner(miguel);
            i12.addImage(new URL(
                    "https://www.vinyltap.co.uk/media/catalog/product/cache/1/image/364x/040ec09b1e35df139433887a97daa66f/i/m/image_236192_3_1_3_5_8_6_6_10_1_266708_1_118752_1_9_1_339533_1_36236_1_106114.jpg"));
            ...
            Item i13 = new Item("Black Labrador Rare Painting by Ivester Lloyd", 1, BigDecimal.valueOf(2269.0),
                    "Rare painting", Categories.ART);
            i13.setOwner(ana);
            i13.addImage(new URL(
                    "https://a.1stdibscdn.com/a_12252/1558701829687/Labrador_master.jpg?disable=upscale&auto=webp&quality=60&width=960"));
            ...
            i14.setOwner(ana);
            i14.addImage(
                    new URL("https://i.etsystatic.com/23439917/r/il/0194b3/2384136403/il_794xN.2384136403_mrwj.jpg"));
            ...
            Item i16 = new Item("Space for Sound - Marilyn Francis", 1, BigDecimal.valueOf(35.0), "First edition",
                    Categories.BOOKS);
            i16.setOwner(pedro);
            ...
            Item i17 = new Item("The Dogged Victims of Dan Jenkins- first edition", 1, BigDecimal.valueOf(227.0),
                    "Livro antigo, primeira edicao", Categories.BOOKS);
            i17.setOwner(ana);
            ...
            Item i18 = new Item("Chimp and Chump by Ruth Carroll", 1, BigDecimal.valueOf(100.0), "1ºedicao",
                    Categories.BOOKS);
            i18.setOwner(miguel);
            ...
            Item i19 = new Item("The Song of the Frog-Rodger Taylor, first edition!", 1, BigDecimal.valueOf(25.0),
                    "Livro primeira edition", Categories.BOOKS);
            i19.setOwner(carlos);
            ...
            // bruh
            Item i20 = new Item("The Evidence of Love by Jacobson, Dan", 1, BigDecimal.valueOf(38.0), "old signed book",
                    Categories.BOOKS);
            i20.setOwner(sofia);
            ...
            Item i21 = new Item("The Erasers by Alain Robbe-Grillet, signed", 1, BigDecimal.valueOf(400.0),
                    "old signed book", Categories.BOOKS);
            i21.setOwner(sofia);
            ...
            Item i22 = new Item("Warriors of the Rainbow by William Willoya and Vinson Brown", 1,
                    BigDecimal.valueOf(35.0), "book is signed", Categories.BOOKS);
            i22.setOwner(ana);
            ...
            Item i23 = new Item("The Man Who Lost His Wife, SYMONS, Julian", 1, BigDecimal.valueOf(64.0),
                    "signed old book", Categories.BOOKS);
            i23.setOwner(miguel);
